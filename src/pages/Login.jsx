      ...
      <div className="right__form m-auto md:mt-auto  md:w-[35vw] py-[2rem]">
        <div className="rounded-[25px] py-8 w-full bg-[#15161B] md:bg-[#ffffff05] px-[3rem]  space-y-2 ">
          ...
          <p className="text-white text-xl pb-5 ">
            ...
            <span className="text-pink-600"> Create New</span>
          </p>
          <button className="flex w-[90%] transition-transform duration-300 ease-in-out transform hover:scale-110  hover:shadow-lg md:w-[80%] m-auto py-2 md:text-sm text-xs  text-white align-middle items-center justify-center gap-2 xl:p-[10px] lg:p-1.5px  border-[1px]  border-white rounded-lg">
          ...
          <button className="bg-[#E1348B] transition-transform duration-300 ease-in-out transform hover:scale-110  hover:shadow-lg md:w-[100%] w-[50%] p-2   rounded-[10px]">
            Login
          </button>
        </div>
      </div>
